...
/**
 * Apache Antタスク [BlancoMeta2Xml]のクラス。
 *
 * ExcelメタファイルからXMLファイルへの変換処理をおこなうAntTaskです。<br>
 * このクラスでは、Apache Antタスクで一般的に必要なチェックなどのコーディングを肩代わりします。
 * 実際の処理は パッケージ[blanco.meta2xml.task]にBlancoMeta2XmlBatchProcessクラスを作成して記述してください。<br>
 * <br>
 * Antタスクへの組み込み例<br>
 * <pre>
...
public class BlancoMeta2XmlTask extends Task {
    /**
     * ExcelメタファイルからXMLファイルへの変換処理をおこなうAntTaskです。
     */
